...
Create and manage PersistentVolumeClaims (PVCs) for persistent storage. PVCs are automatically mounted in the main application container when `mountPath` is specified. Init containers and sidecars require their own PVC or volume-mount configuration.
